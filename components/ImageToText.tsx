...
const ImageToText = () => {
  ...
  const doOCR = async () => {
    Tesseract.recognize(fileUrl, "eng", { logger: (m) => console.log(m) }).then(
      ({ data: { text } }) => {
        setOutText(text);
        setOcrLoad(false);
      }
  ...
  return (
    ...
    >
      ...
      <Image
        src={
          "https://user-images.githubusercontent.com/112304655/216254923-0db067c6-c1ac-45e1-a62c-ae7777e4eaf7.svg"
        }
        alt={"Hello"}
      />
    </Flex>
